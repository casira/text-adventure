...
function westTunnel() {
  ...
  if (choice === null) {
    ...
    alert(
      "You break into a dead sprint back the way you came! The rocks barely missing you as the tunnel crumbles around you! You run so fast you dart straight into the east tunnel!"
    );
    eastTunnel();
  } else if (choice === "face") {
...
function traps() {
  ...
  if (choice === null) {
    ...
    alert(
      "You begin sprinting through the opening, but with your speed you clumsly slam your foot into one of the false stones! You look up just in time to see a massive boulder fall from the ceiling crushing you! YOU DIED!!"
    );
    return;
  }
}
...
function eastTunnelPrt2() {
  ...
  if (choice === null) {
    ...
    alert(
      "You watch the dragon but the dragon also watches you! Faster than you can react the massive beast whips around and dive bombs directly at you! In one massive chomp the dragon eats half of the cliff side and you with it. YOU DIED!!"
    );
    return;
  } else if (choice === "hide") {
    alert(
      "You dart back into the tunnel and hide against the wall. Perfect timing because the dragon spins around and begins heading for exactly where you were standing! It takes a massive chomp out of the cliff side!"
    );
    alert(
      "The dragon heads towards the back of the cave where it lands. It curls into a scaley ball and seems to fall asleep."
    );
    alert(
      "The chomp the dragon left creates a rocky ramp down to the cave floor. You slide down and see the dragon asleep a mere 200 feet infront of you!"
    );
    caveFloor();
  }
}
